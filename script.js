...
let questions = [
    ...
    options: [
      ...
      "B. Tags and attributes are case-insensitive ",
      "C.  Special characters must be escaped using character entities",
      "D. Charset in html is “text/html” where as in xhtml it is “application/xml+xhtm"
    ]
  },
    {
    numb: 4,
